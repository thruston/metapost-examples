...
\newpage
Armed with these expressions, you can draw a family of non-intersection coaxial
Apollonian circles.
$$
\begin{mplibcode}
...
Next consider orthogonal circles, where the tangents at the intersections are at
...
draw c1 withcolor Oranges 8 7;
draw c2 withcolor Blues 8 7;
dotlabel.bot("$O_1$", o1);
dotlabel.lrt("$O_2$", o2);
