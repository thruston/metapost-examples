...
&a^2 + b^2 - 2ab\cos\theta\cr}} etex, point 1/2 of bbox currentpicture shifted 32 down);
\end{mplibcode}
$$
\vfill
...
draw thelabel.top("$2a\cos\theta-b$", origin) rotated -1/2(180-45b) shifted 1/2[z0, point b of c];
draw thelabel.top("$b$",              origin) rotated -1/2(180-45b) shifted 1/2[z0, point 0 of c];

label.bot(btex \vbox{\openup 8pt\halign{\hfil $#$ \hfil\cr
\bigl(2a\cos\theta - b\bigr) \cdot b = \bigl( a - c \bigr) \cdot \bigl(a + c \bigr)\cr
c^2 = a^2 + b^2 - 2ab\cos\theta\cr}} etex, point 1/2 of bbox currentpicture shifted 42 down);
