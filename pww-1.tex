...
P1 = image(
    for n = N downto 1:
        ...
        for m = 1 upto n-1:
            ...
            for z = 1 upto n:
                for x = 0 upto m-1:
                    draw if n < N: white_cube else: b_cube fi shifted p(b + x, 0, a + n - z);
                endfor
            endfor
        endfor
        for x = 0 upto n-1:
            for z = 1 upto n:
                draw if n < N: white_cube else: b_cube fi shifted p(a + x, 0, a + n - z);
            endfor
        endfor
    endfor
    for n = 1 upto N:
        ...
        for m = n-1 downto 1:
            ...
            for x = 0 upto n-1:
                for z = 1 upto m:
                    draw if n < N: white_cube else: b_cube fi shifted p(a + x, 0, b + m - z);
                endfor
            endfor
        endfor
    endfor
...
P2 = image(
    for y = 0 upto N - 1:
        for x = 1 upto N - y:
            for z = N downto 1:
                draw b_cube shifted p(x, 1.125y - 1, z);
            endfor
        endfor
    endfor
);
