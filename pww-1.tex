...
label.top(btex  
\def\V#1{\mathop{\textrm{V}}\nolimits\!\left(#1\right)} $\displaystyle
    \V{P_1} = {h\over b-a}\cdot \V{P_2} = {h\over b-a}\cdot{1\over3}\left(b^3-a^3\right)
