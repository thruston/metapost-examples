...
P2 = image(
    for i=n downto 1:
        ...
        label("$" & if i=n: "n(n+1)(n+2)" elseif i=n-1: "\cdots" else:
...
\begin{mplibcode}
    picture t[];
    t0 = image(fill fullcircle scaled 4 withcolor 1/2[blue, white]; draw fullcircle scaled 4);
    for i=1 upto 5:
        numeric delta; delta = 2**(i-1);
        t[i] = image(
            draw t[i-1];
            draw t[i-1] shifted ((6 delta, 0) rotated -60);
            draw t[i-1] shifted ((-6 delta, 0) rotated 60);
        );
    endfor
    numeric x; x = 0;
    ...
    drawdot (90, -80) withpen pencircle scaled 3.6 withcolor 3/4[red, white];
