...
% DUMP capture=False, replace="% plus the display labels..."
...
% DUMP capture=False, replace="% ... plus simpler loops for P3 and P4"
P3 = image(
  for k=0 upto 3:
    for j=3-k downto 0:
...
% DUMP capture=False, replace="% P2 and P3 are similar, but longer..."
P2 = image(
for j=-4 upto 0:
    for k=0 downto j:
        for i=0 upto -k:
...
% DUMP capture=False, replace="% see source for the TeX label at the top"
...
% DUMP capture=False, replace="% ... and so on"
% now together...
...
% DUMP capture=False, replace="% see source for octaframe routine "
...
% DUMP capture=False, replace="% ... finally place P[] and labels "
...
% DUMP capture=False, replace="% P2 is similiar..."
P2 = image(
  for i=n downto 1:
...
% DUMP capture=False, replace="% .. and so on for P3 and P4"
P3 = image(
